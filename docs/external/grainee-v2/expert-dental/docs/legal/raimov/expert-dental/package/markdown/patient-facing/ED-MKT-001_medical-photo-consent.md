...
doc_id: ED-MKT-001
version: 0.1-draft
title: Согласие на медицинскую фото-/видеофиксацию
...
# Согласие на медицинскую фото-/видеофиксацию
...
Фиксация диагностики, планирования, динамики и клинической записи. Это согласие не разрешает рекламу, соцсети, сайт, обучение или публикацию.

## Объём

Область/тип изображения, устройство и ограничения: __________

## Доступ и хранение

Только в утверждённой клинической системе; личные телефоны, camera roll и личные облака сотрудников запрещены. Срок — по утверждённой retention schedule (OPEN GAP).

## Выбор

Согласен(на) / не согласен(на). Последствия отказа для возможности документировать/оказать конкретную помощь объясняет врач: __________
