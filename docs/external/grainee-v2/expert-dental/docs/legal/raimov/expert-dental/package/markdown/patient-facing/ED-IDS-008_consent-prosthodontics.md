...
Профиль лицензии и credentials конкретного врача не подтверждены. До clearance использовать запрещено.

## Вмешательство

Конструкция/зубы/этапы, препарирование, временная конструкция, лаборатория, примерки, фиксация: __________

## Альтернативы

Реставрация, имплантация, съёмное/несъёмное протезирование, наблюдение, удаление или отказ — по индивидуальной оценке.

## Существенные риски

Чувствительность/боль, необходимость эндодонтии, скол/расцементировка/износ, несоответствие оттенка, адаптация прикуса/речи, воспаление, ограниченный срок службы, повторное изготовление при документированных показаниях.
