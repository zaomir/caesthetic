...
doc_id: ED-IDS-004
version: 0.1-draft
title: ИДС — хирургия / удаление зуба
owner: Expert Dental legal owner + clinic medical director
status: COUNSEL_REVIEW_REQUIRED / MEDICAL_REVIEW_REQUIRED / BLOCKED_EVIDENCE
...
# ИДС — хирургия / удаление зуба

> **COUNSEL_REVIEW_REQUIRED / MEDICAL_REVIEW_REQUIRED / BLOCKED_EVIDENCE. НЕ ДЛЯ РЕАЛЬНЫХ ПАЦИЕНТОВ И НЕ IN_USE.** Требуются письменные approvals, evidence gates, регистрация версии и go-live акт.
...
- Required approvals: **COUNSEL_REVIEW_REQUIRED, MEDICAL_REVIEW_REQUIRED, BLOCKED_EVIDENCE**
...
Хирургический профиль лицензии и credentials врача не подтверждены. До clearance использовать запрещено.

## Вмешательство

Диагноз/зуб/сторона, вид удаления/операции, анестезия и план: __________

## Альтернативы

Сохранение/эндодонтическое/пародонтологическое/ортопедическое лечение, наблюдение при допустимости, направление либо отказ: __________

## Существенные риски

Боль, кровотечение, отёк, инфекция, сухая лунка, повреждение соседних структур, фрагмент корня, сообщение с пазухой, повреждение нерва с изменением чувствительности, перелом, повторная операция/госпитализация.
