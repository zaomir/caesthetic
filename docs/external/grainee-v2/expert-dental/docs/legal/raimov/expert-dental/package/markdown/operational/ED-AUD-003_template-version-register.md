...
doc_id: ED-AUD-003
version: 0.1-draft
title: Реестр шаблонов и версий — рабочая форма
...
# Реестр шаблонов и версий — рабочая форма
...
DOC-ID; title; version; language; owner; legal reviewer/date; medical reviewer/date; effective date; status; blank artifact SHA256; signers; retention class; supersedes; next review; repository path; CRM template ID.

## Правило

Новая версия — новый immutable artifact и строка. SUPERSEDED запрещает новое использование, но не удаляет подписанные экземпляры. Неизвестный/просроченный version ID блокируется.

## Запись

DOC-ID: __________  Version: __________  SHA256: __________  Approvals: __________  Effective: __________  Status: COUNSEL_REVIEW_REQUIRED / MEDICAL_REVIEW_REQUIRED / APPROVED_NOT_IN_USE / SUPERSEDED.
