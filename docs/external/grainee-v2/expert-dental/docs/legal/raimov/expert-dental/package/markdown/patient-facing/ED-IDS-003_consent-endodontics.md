...
doc_id: ED-IDS-003
version: 0.1-draft
title: ИДС — эндодонтическое лечение
...
Диагноз/зуб: __________  Этапы: доступ, обработка/дезинфекция, пломбирование каналов, временное/постоянное восстановление: __________

## Альтернативы

Перелечивание, хирургический эндодонтический вариант, удаление, наблюдение при допустимости или отказ: __________

## Существенные риски

Боль/отёк, flare-up, неполное выявление каналов, перфорация, поломка инструмента, выведение материала, трещина/перелом зуба, необходимость повторного лечения/операции/удаления, неполное заживление.

## После лечения

Необходимость окончательного восстановления и контрольных визитов объяснена. Индивидуальные ограничения: __________
