...
doc_id: ED-CMP-005
version: 0.1-draft
title: Возврат / соглашение об урегулировании
...
# Возврат / соглашение об урегулировании
...
Complaint/refund ID: __________  Позиция пациента: __________  Clinical review отдельно: __________  Документ не является автоматическим признанием нарушения.

## Расчёт

Получено: __________  Фактически оказано: __________  Документированные прямые расходы: __________  Решение/сумма/способ: __________

## Условия

Continuity/remediation, сроки и способ оплаты, выдача документов: __________. Никакое условие не отменяет неотчуждаемые права пациента.

## Согласования

Business owner: __________  Finance: __________  Counsel/insurer, если gate применим: __________
