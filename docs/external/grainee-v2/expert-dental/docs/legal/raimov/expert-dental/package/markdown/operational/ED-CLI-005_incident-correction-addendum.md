...
doc_id: ED-CLI-005
version: 0.1-draft
title: Инцидент / исправление / датированное дополнение
...
# Инцидент / исправление / датированное дополнение
...
Incident / correction / addendum. Исходный object ID/version/hash: __________  Case ID: __________

## Текущее событие

Обнаружено кем/когда: __________  Факты без ретро-реконструкции: __________  Причина дополнения/коррекции: __________

## Действие

Новая корректная информация, clinical safety action, notifications, containment, links to evidence: __________

## Неизменяемость

Исходная запись не удаляется и не перезаписывается. Новая запись имеет текущие server date/time, автора, reason code и hash. Legal hold: __________
