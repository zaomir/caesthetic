...
**Current public product:** `RAIM SMILE · SmileCare 12` with unchanged legacy benefit binding
**Legacy product name:** `Expert Care 12`
**Approved endorsed form:** `RAIM SMILE · SmileCare 12`
...
- display: `SmileCare 12`;
- endorsed display: `RAIM SMILE · SmileCare 12`;
...
- public/current name is `RAIM SMILE · SmileCare 12`;
