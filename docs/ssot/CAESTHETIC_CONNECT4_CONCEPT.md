...
version: 1.1.0
updated: 2026-09-04
scope: Connect4 concept and How we work explanation; approved desktop journey visual and separately provisional general copy/layout
...
Основание: обсуждение владельца 2026-09-04 о каталоге кейсов, четырёх плоскостях, Lead Intake, системе честных отзывов и публичном названии Connect4. Семантические решения в §2–7 закреплены; формулировки в §8 и общие предложения §9 остаются рабочими вариантами; точная desktop-картинка маршрута отдельно утверждена в §9.1. Запрос генерации изображения сам по себе не означает утверждения его геометрии или текста.
...
Ранние эскизы и сгенерированные варианты остаются материалами обсуждения. Исключение — конкретная последняя картинка маршрута, явно утверждённая владельцем и сохранённая в §9.1. Она не заменяет существующие защищённые иллюстрации других форматов.

Общие предложения для других композиций (desktop-маршрут отдельно закреплён в §9.1):
...
Существующая грамматика устного клиентского эскиза в master §2.3 остаётся действующей: пунктир **проходит через четыре блока**, внешний сплошной контур обозначает одного владельца логики. Простое окружение блоков пунктиром не равно их соединению. Для общей страничной схемы ещё нужно решить, как она показывает владельца логики. Утверждённая иллюстрация конкретного маршрута §9.1 имеет собственную зафиксированную композицию и не переопределяет грамматику устного эскиза. Публичная страница с именем Connect4 и problem-first устная презентация — разные контексты; порядок раскрытия цены/продукта из устного сценария не переносится механически на заголовок веб-секции.
