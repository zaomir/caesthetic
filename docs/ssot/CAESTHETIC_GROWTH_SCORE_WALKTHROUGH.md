...
The schema-v5 report contains exactly one Primary plus exactly two Supporting Focus Gaps. The spoken Top 3 preserve that named-human order without re-ranking. Localization cannot replace, promote or invent a different priority.
