...
This satellite file intentionally does **not** duplicate the operating SSOT.

The sole canonical audit-factory authority is:

`zaomir/grainee-v2/docs/ssot/CAESTHETIC_GROWTH_SCORE_PRODUCTION_SOP.md`
...
Do not edit audit-factory policy in this satellite file. Changes must be made in the canonical `zaomir/grainee-v2` SSOT first. This pointer exists specifically to prevent an independently editable second copy from becoming stale.

Runtime remains in `zaomir/grainee-v2`; this repository remains the CAESTHETIC satellite surface.