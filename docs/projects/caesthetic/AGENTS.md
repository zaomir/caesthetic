...
3d. Entertainment/VOC lane: `docs/projects/caesthetic/operations/ig-growth/11-ENTERTAINMENT_REELS_ROTATION_PLAN.md`, `docs/ssot/CAESTHETIC_ENTERTAINMENT_VOC_TOPIC_BANK.md`, `docs/ssot/CAESTHETIC_ENTERTAINMENT_REELS_REFERENCE_MAP.md`, `docs/ssot/CAESTHETIC_SHORT_FORM_VIRAL_REFERENCE_SYSTEM.md`
