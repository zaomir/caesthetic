...
- Growth Score production workflow / SOP / how to produce a Score → `docs/ssot/CAESTHETIC_GROWTH_SCORE_PRODUCTION_SOP.md`.
- Growth Score vertical vocabulary and report/walkthrough locale context → `docs/caesthetic/growth_score_spec.md` §0.1, then the production SOP and `docs/ssot/CAESTHETIC_GROWTH_SCORE_WALKTHROUGH.md`; this is one product/template and does not change scoring or the product ladder.
...
- `/score/<slug>/` — private/noindex owner cockpit: secondary score navigator plus primary evidence, Problem Inventory, priorities and remediation plan
