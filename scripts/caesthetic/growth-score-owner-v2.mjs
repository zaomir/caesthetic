...
export function ownerV2Document(report, result) {
  ...
  const constraint = t(
    "Связь запросов, контента и отзывов пока не подтверждена.",
    "Query, content and review alignment is not yet established.",
  );
  const qualifier = t(
