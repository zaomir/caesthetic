...
export function ownerV2Document(report, result) {
  if (
    ...
    throw new Error(
      "Owner v2 is limited to the approved клиника case and its RU/EN presentation.",
    );
