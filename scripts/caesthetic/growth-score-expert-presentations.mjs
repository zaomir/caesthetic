...
<footer class="footer"><span>Команда CAESTHETIC</span><span>${version} · ${e(m.research_date)}</span><a href="mailto:info@caesthetic.com">Задать вопрос</a></footer></main><script type="module">${client}</script></body></html>\n`;
}
