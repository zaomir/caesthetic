...
const report = {
  ...
  humanDiagnosis: {
    ...
    focus_selection: { primary_gap_id: "NVR-26-01", supporting_gap_ids: ["NVR-26-02", "NVR-26-03"], selected_by: "Travis Warner", selected_at: approvedAt, rationale: "Website/source of truth — binding dependency. GBP и Instagram должны сходиться на нём. Reputation остаётся в полном Gap Inventory и возвращается после появления достаточного окна наблюдения." },
    ...
    coordination_burden: { diagnosed_issues: 8, high_priority_fixes: 3, systems_involved: 4, dependencies: 6, specialist_roles: 5 },
  },
