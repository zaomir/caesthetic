...
PROTECTED_PREFIXES = (
    ...
    "scripts/caesthetic/growth-score-owner-v2.mjs",
    "scripts/caesthetic/spoken-v2-browser-qa.mjs",
    "tests/caesthetic/spoken-medspa-v2.test.mjs",
    "tests/caesthetic/fixtures/spoken-v1-hashes.json",
    "docs/audits/caesthetic/growth-score/cases/spoken-medspa-snellville-2026/v2-acceptance/",
