...
export const ALLOWED_TRANSITIONS = Object.freeze({
  ...
  fact_set_frozen: Object.freeze(["gap_review", "draft_review", "closed"]),
  gap_review: Object.freeze(["report_review", "fact_set_frozen", "closed"]),
  report_review: Object.freeze(["approved", "gap_review", "closed"]),
...
export const NEXT_ACTIONS = Object.freeze({
  ...
  fact_set_frozen: "assemble_gap_inventory",
  gap_review: "select_focus_gaps",
  report_review: "approve_schema_v5",
