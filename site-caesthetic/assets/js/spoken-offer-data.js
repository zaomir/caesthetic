...
export const SPOKEN_OFFER = Object.freeze({
  ...
  practice: 'Spoken Med Spa',
  product_code: 'growth_sprint',
  amount_minor: 250000,
  currency: 'USD',
  title: 'One clear first visit. Four connected surfaces.',
  scope: 'A 30-day implementation project for Spoken Med Spa: align the agreed first-visit information and enquiry routes across Google, website and blog, social profiles and posts, and reputation pages and practice replies.',
  deliverables: [
