...
(function initGrowthCockpit() {
  ...
  const COPY = {
    en: {
      ...
      sprintPrice: "Price scoped to work · 30 days",
    ...
    ru: {
      ...
      sprintPrice: "Цена определяется по объёму работ · 30 дней",
    ...
    es: {
      ...
      sprintPrice: "Precio según el alcance · 30 días",
    ...
    fr: {
      ...
      sprintPrice: "Prix selon le périmètre · 30 jours",
    ...
    uk: {
      ...
      sprintPrice: "Ціна визначається за обсягом робіт · 30 днів",
